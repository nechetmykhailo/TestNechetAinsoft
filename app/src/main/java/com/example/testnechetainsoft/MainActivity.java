...
import com.example.testnechetainsoft.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.fabAdd.setOnClickListener(v -> {
            ...
            Shops.getInstance().setFLAG_ADD(1);
        });
        ...
        mAdapter.setMyInterface(new RecyclerAdapterShop.MyInterface() {
            ...
            public void btnChange(int positions, String name, String descriptions, String image) {
                ...
                Shops.getInstance().setFLAG_ADD(1);
                Shops.getInstance().setFLAG_CHANGE(1);
            ...
            public void btnDel(int positions, String name) {
                sqLiteDatabase = sqLiteConnector.getWritableDatabase();
                sqLiteConnector.deletinItemShop(name);
    ...
    private void init() {
        ...
        mAdapter = new RecyclerAdapterShop(getApplicationContext(), modelShops, 1);
        binding.rwShop.setAdapter(mAdapter);
    }

    private void getDBData() {
        Cursor cursor = sqLiteConnector.getReadableDatabase().query("Shop"
