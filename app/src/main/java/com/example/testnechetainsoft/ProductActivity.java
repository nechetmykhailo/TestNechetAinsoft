...
import com.example.testnechetainsoft.databinding.ActivityProductBinding;
...
public class ProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.fabAdd.setOnClickListener(v -> {
            ...
            Shops.getInstance().setFLAG_ADD(3);
        });
        ...
        mAdapter.setMyInterface(new RecyclerAdapterShop.MyInterface() {
            ...
            public void btnChange(int positions, String name, String descriptions, String image) {
                ...
                Shops.getInstance().setFLAG_ADD(3);
                Shops.getInstance().setFLAG_CHANGE(3);
            ...
            public void btnDel(int positions, String name) {
                sqLiteDatabase = sqLiteConnector.getWritableDatabase();
                sqLiteConnector.deletinItemProduct(name);
    ...
    private void init() {
        ...
        mAdapter = new RecyclerAdapterShop(getApplicationContext(), modelShops, 3);
        binding.rwShop.setAdapter(mAdapter);
    }

    private void getDBData() {
        Cursor cursor = sqLiteConnector.getReadableDatabase().query("Product"
